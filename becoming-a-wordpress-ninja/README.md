# Based on reveal.js, but with ISITE's branded theme
...
```
$ git clone git@gitlab.isitedesign.com:tech/tweek.git
```

4. Navigate to the tweek folder
```
$ cd tweek
```
...
- **img/slideshow-name/** If you wish to use images in your presentation, create a folder with your slideshow name and place your images there
- **plugin/** Components that have been developed as extensions to reveal.js
- **slideshows/** Using template.html as a basis, save your presentation to this folder and make sure to change the <title> attribute in the HTML to be a reader-friendly name.  This will be displayed on the table of contents slideshow (/index.php)
